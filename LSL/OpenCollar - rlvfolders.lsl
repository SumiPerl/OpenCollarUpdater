                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if ((llSubStringIndex(sMsg,",") >=0) && (g_iRLVaOn)) { //we have multiple results, bring up a menu
                            ...
                            string sPrompt = "Multiple results found.  Please select an item from the list\n";
                            sPrompt += "Current action is "+g_sFolderType+"\n";
                            g_kMultipleFoldersOnSearchMenuID = Dialog(kID, sPrompt, lMultiFolders, [UPMENU], 0, iChan);
                            return;
                        }
